...
namespace KadenceWP\KadenceBlocks\LiquidWeb\Harbor;
	...
	public static function init(): void {
		if ( ! Config::has_container() ) {
			throw new RuntimeException(
				__( 'You must call LiquidWeb\Harbor\Config::set_container() before calling LiquidWeb\Harbor::init().', 'kadence-blocks' )
			);
		}
