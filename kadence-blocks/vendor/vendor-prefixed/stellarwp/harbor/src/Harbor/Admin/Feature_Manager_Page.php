...
namespace KadenceWP\KadenceBlocks\LiquidWeb\Harbor\Admin;

use KadenceWP\KadenceBlocks\LiquidWeb\Harbor\Config;
use KadenceWP\KadenceBlocks\LiquidWeb\Harbor\Harbor;
use KadenceWP\KadenceBlocks\LiquidWeb\Harbor\Licensing\License_Manager;
...
use KadenceWP\KadenceBlocks\LiquidWeb\Harbor\Utils\Version;
/**
...
class Feature_Manager_Page
{
    ...
    public function maybe_register_page(): void
    {
        ...
        $this->page_hook = add_menu_page(__('Liquid Web Software Manager', 'kadence-blocks'), __('Liquid Web', 'kadence-blocks'), 'manage_options', self::PAGE_SLUG, [$this, 'render'], 'dashicons-cloud', 3);
